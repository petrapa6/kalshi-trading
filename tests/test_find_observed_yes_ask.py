def test_normalize_team_name_casefold_and_whitespace():
    from predictions.teams import normalize_team as _normalize_team
...
def test_market_title_contains_both_teams_matches():
    from predictions.teams import market_mentions_both_teams as _market_mentions_both_teams
